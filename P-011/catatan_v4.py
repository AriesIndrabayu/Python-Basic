...
def tampilkan_menu():
    ...
    print("5. Cari Catatan")  # penambahan menu
    print("6. Ekspor Catatan Ke File Lain")  # penambahan menu
    print("7. Keluar")
...
def proses_pilihan(pilihan):
    ...
    if pilihan == "1":
        ...
        print("⚠ Pilihan tidak valid. Silahkan pilih angka 1-7\n")
...
def main():
    ...
    while True:
        ...
        if pilihan not in {"1", "2", "3", "4", "5", "6", "7"}:  # set literal
            print("⚠ Pilihan tidak valid. Silahkan pilih angka 1-7\n")
            continue
